...
#large moving window of 500
low_rs_frac_large_window = compute_30mer_data_from_seq_name_custom_moving_window('Q5T6F2_93_1119',500)
high_rs_frac_large_window = compute_30mer_data_from_seq_name_custom_moving_window('Q9H4Z2_1_1027',500)

#tiny moving window of 30
low_rs_frac_small_window = compute_30mer_data_from_seq_name_no_hdf5('Q5T6F2_93_1119',3)
high_rs_frac_small_window = compute_30mer_data_from_seq_name_no_hdf5('Q9H4Z2_1_1027',3)

#save small window to csv file
low_rs_frac_small_window.to_csv('subchain_30_Q5T6F2_93_1119_low_Rs_frac.csv',index=False)
high_rs_frac_small_window.to_csv('subchain_30_Q9H4Z2_1_1027_high_Rs_frac.csv',index=False)

low_rs_frac_large_window.to_csv('subchain_500_Q5T6F2_93_1119_low_Rs_frac.csv',index=False)
high_rs_frac_large_window.to_csv('subchain_500_Q9H4Z2_1_1027_high_Rs_frac.csv',index=False)
